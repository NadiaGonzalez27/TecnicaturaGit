...
public class HolaMundo {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("\t\t.:MENU:.");//Diagonal inversa y letra t
 ...
 /*float numFloat = 3.4028235E38F;
        ...
        char varCaracterSimbolo = '$'; //Un caracter especial, podemos copiar y pegar
        ...
        var varCaracterSimbolo1 = '$'; //Un caracter especial, podemos copiar y pegar
...
//        System.out.println("entrada = " + entrada);
 ...
 /* int num1 = 5, num2 = 4;
        ...
        solucion = num1 % num2; //Guerda el residuo entero de la division
 ...
 /*int varNum1 = 1, varNum2 = 4;
        ...
        var varC =true; //Esta loiteral por default en Java es de tipo boolean
        ...
        System.out.println("varF = " + varF); //Va a sumar unon
