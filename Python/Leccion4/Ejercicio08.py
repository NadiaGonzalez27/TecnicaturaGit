...
while True:
    print("\t.:MENÚ:.")
    print("1. Ingresar dineroen la cuenta")
    print("2. Retirar dinero de la cuenta")
    print("3. Mostrar dinero disponible")
    print("4. Salir")
    opcion = int(input("Digite una opciom de menú: "))
    if opcion == 1:
        ...
        print(f' Dinero en la cuenta al moemnto: ${saldo}')
    elif opcion == 4:
        print('Gracias por utilizar su cajero automatico, hasta pronto')
        break
    else:
        print('Error, se equivoco opcion de menú')
        print()
