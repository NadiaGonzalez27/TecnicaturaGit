...
# Recorremos los elelmentos de la tupla
...
for termino in diccionario: # Recorremos mosgtrando solo las llaves
    print(termino)
...
# Como saber cuantos repetidos hay dentro de una lista
...
conjunto2 = set() # unica manera de inicializar basido
conjunto1 = {'bye',}
conjunto2.add(7)
conjunto2.add('Hola')
print(conjunto2)
...
conjunto3 = conjunto1 ^ conjunto2 # elementos que no comparten o que son diferentes de ambos
print(conjunto3)
...
print(conjunto3.issuperset(conjunto2)) # Si es verdadero quiere decir que le conjunto3 es un superconjunto
print(conjunto2.issuperset(conjunto3))

# Como saber ambos conjuntos son disconexos, esto es si no comparten elementos en comun
...
seleccionArgentina = {
    ...
    5: {'Nombre': 'Leandro Paredes', 'Edad': 28, 'Altura': 1.80, 'Precio': '17 Millones', 'Posicion': 'Medio Campista'},
    3: {'Nombre': 'Nicolas Tagliafico', 'Edad': 30, 'Altura': 1.72, 'Precio': '15 Millones', 'Posicion': 'Defensor'},
    17: {'Nombre': 'Alejandro Gomez', 'Edad': 34, 'Altura': 1.67, 'Precio': '6 Millones', 'Posicion': 'Medio Campista'},
    22: {'Nombre': 'Lautaro Martinez', 'Edad': 25, 'Altura': 1.74, 'Precio': '75 Millones', 'Posicion': 'Delantero'}
}
